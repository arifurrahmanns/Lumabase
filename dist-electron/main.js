...
electron.app.whenReady().then(() => {
  ...
  electron.ipcMain.handle("engine-remove", async (event, id) => {
    return engineController.removeInstance(id);
  });
  electron.ipcMain.handle("engine-start", async (event, id) => {
    return engineController.startInstance(id);
  });
  electron.ipcMain.handle("engine-stop", async (event, id) => {
